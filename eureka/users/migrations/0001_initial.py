    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified', models.BooleanField(default=False, help_text='Set to true when the user has verified its email adress.', verbose_name='verified')),
                ('is_active', models.BooleanField(default=True, help_text='Set to true when the user has an active account.', verbose_name='active')),
                ('jobs_created', models.PositiveIntegerField(default=0, help_text='Shows the number of jobs created.', verbose_name='Jobs created')),
                ('jobs_applied', models.PositiveIntegerField(default=0, help_text='Shows the number of jobs applied.', verbose_name='Jobs applied')),
